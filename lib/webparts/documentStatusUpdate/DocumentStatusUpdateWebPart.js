            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.context.spHttpClient.get("".concat(this.siteUrl, "/_api/web/lists/getbytitle('").concat(this.listName, "')/items?$filter=ReferenceCode eq '").concat(filterCode, "'&$select=Id,Title,ReferenceCode,Status,From,Document_x0020_Type,Document_x0020_Format,OtherRemarks"), SPHttpClient.configurations.v1, {
                                headers: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.context.spHttpClient.post("".concat(this.siteUrl, "/_api/web/lists/getbytitle('").concat(this.listName, "')/items(").concat(this.currentItem.Id, ")"), SPHttpClient.configurations.v1, {
                                headers: {
                                    'Accept': 'application/json;odata=nometadata',
...
export default DocumentStatusUpdateWebPart;
//# sourceMappingURL=DocumentStatusUpdateWebPart.js.map