...
(() => {
/*!******************************************************************!*\
  !*** ./lib/webparts/documentTimeline/DocumentTimelineWebPart.js ***!
  \******************************************************************/
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all([
                                this.context.spHttpClient.get("".concat(this.siteUrl, "/_api/web/lists/getbytitle('").concat(this.listName, "')/items?$filter=ReferenceCode eq '").concat(filterCode, "'"), _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_1__.SPHttpClient.configurations.v1, { headers: { 'Accept': 'application/json;odata=nometadata', 'odata-version': '' } }),
                                this.context.spHttpClient.get("".concat(this.siteUrl, "/_api/web/lists/getbytitle('").concat(this.statusLogListName, "')/items?$filter=Title eq '").concat(filterCode, "'&$orderby=Created asc"), _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_1__.SPHttpClient.configurations.v1, { headers: { 'Accept': 'application/json;odata=nometadata', 'odata-version': '' } })
                            ])];
                    case 2:
                    ...
                    groups: [
                        {
                            ...
                            groupFields: [
                                ...
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneTextField)('statusLogListName', {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DocumentTimelineWebPart);
...
//# sourceMappingURL=document-timeline-web-part.js.map